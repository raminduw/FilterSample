...
@Singleton
@Component(modules = {UserRepositoryModule.class, ApiModule.class,SchedulerModule.class,DisposableModule.class,FilterOptionModule.class, FilterManager.class, GeoDistanceCalculator.class})
public interface AppComponent {
    ...
    GeoDistanceCalculator getGeoLocationCalculator();
}
